...
description: Learn how to create a webhook in Adobe Commerce as a Cloud Service or Adobe Commerce
keywords:
  - Extensibility
---
...
Webhooks can be defined in multiple ways. With Adobe Commerce as a Cloud Service (ACCS), you can define webhooks from the Admin or with REST. In Adobe Commerce, you must use XML files to define webhooks. The following sections describe how to create webhooks in both environments. Regardless of the method you choose, all webhook definitions can contain the following components:

* The basic properties of the webhook, such as the method name, type, external URL, and HTTP method.
* The fields to transmit in the webhook request.
* Headers 
