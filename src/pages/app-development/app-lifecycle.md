---
title: App Builder app lifecycle for Adobe Commerce
...
# App Builder app lifecycle for Adobe Commerce
...
- [Credentials management](../plan/best-practices/credentials.md) - Securely handle API keys, tokens, and secrets
- [Logging and troubleshooting](../plan/best-practices/logging-troubleshooting.md) - Implement effective logging for debugging
- [Database storage](../plan/best-practices/database-storage.md) - Choose appropriate storage solutions for your app data
...
Apps must support both PaaS (Commerce on cloud infrastructure, on-premises) and SaaS (Commerce as a Cloud Service) deployments. See [Extension compatibility](../plan/extension-compatibility.md) for guidance.
...
- **New to App Builder?** Start with the [learning path](../get-started/learning-path.md) to understand the ecosystem
- **Have a specific integration need?** Explore the [starter kits](../starter-kit/integration/index.md) for pre-built patterns
- **Ready to build custom functionality?** Dive into [Events](../events/index.md), [Webhooks](../webhooks/index.md), or the [Admin UI SDK](../admin-ui-sdk/index.md)
