...
- **Item prices** — fires during cart totals collection, immediately after the subtotal is computed. The app doesn't declare this webhook out of the box; add your own runtime action and register it. See [Item price use cases](totals-collector-item-prices.md#item-prices-webhook) for registration details and response format.
