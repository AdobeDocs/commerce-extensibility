...
```json
{
    "rateRequest": {
        ...
        "address_custom_attributes": {
            "custom_attribute_one": "value_one",
            ...
        }
    }
}
