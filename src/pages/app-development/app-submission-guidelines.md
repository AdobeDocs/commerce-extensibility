...
- Installation guide clarity
  ...
  - **PaaS vs SaaS configuration**: Document variables that differ based on Commerce flavor.
    - Explain differences in the structure of the `AIO_COMMERCE_API_BASE_URL` value  if the variable is used (see [Download and configure the integration starter kit](https://developer.adobe.com/commerce/extensibility/starter-kit/integration/create-integration/#download-and-configure-the-integration-starter-kit) for an explanation)
