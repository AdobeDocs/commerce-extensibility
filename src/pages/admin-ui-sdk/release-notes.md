...
* Added request ID to logs when database logging is enabled. <!-- CEXT-4848, CEXT-5056 -->

### Bug fixes

* Fixed mapping of API Mesh for applications deployed on non-Production workspace. <!-- CEXT-5052 -->
