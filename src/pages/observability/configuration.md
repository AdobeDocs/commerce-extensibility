...
For [storefront](https://experienceleague.adobe.com/en/tools/commerce-storefront/) observability, refer to [Operational Telemetry](https://www.aem.live/docs/operational-telemetry).
