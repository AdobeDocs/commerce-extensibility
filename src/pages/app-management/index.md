...
1. (Optional) **Add custom installation steps**. Define [custom installation scripts](./installation/index.md#custom-installation-steps) that run when merchants install your app.
