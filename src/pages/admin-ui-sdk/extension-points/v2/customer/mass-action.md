...
| `selectionLimit` | integer | No | The maximum number of customers that can be selected for the mass action. The default value is `-1` (unlimited). |
...
The Adobe Commerce Extensibility Code Samples repository demonstrates how to customize [customer mass actions](https://github.com/adobe/adobe-commerce-samples/tree/main/admin-ui-sdk/v2/customer/custom-mass-action).
