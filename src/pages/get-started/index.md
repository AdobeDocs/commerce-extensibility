...
Adobe Commerce's extensibility options provide robust mechanisms for customizing and enhancing e-commerce platforms:

- **In-process** offers simplicity and performance for direct customizations
- **Out-of-process** provides isolation and scalability for complex integrations
- **Hybrid** combines both approaches when needed

Choose based on your specific requirements, the complexity of customizations, and your performance and scalability needs.

## Next steps

Ready to build an out-of-process app? See the [app development lifecycle](../plan/index.md) for a complete roadmap from planning through production.
