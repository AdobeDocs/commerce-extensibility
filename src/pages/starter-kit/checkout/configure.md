...
To create tax integrations in Adobe Commerce, use [`create-tax-integrations`](https://github.com/AdobeDocs/commerce-extensibility/blob/main/src/pages/starter-kit/checkout/configure.md) script.
